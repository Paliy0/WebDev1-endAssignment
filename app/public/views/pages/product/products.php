        ...
        <div class="row">
            <?php foreach ($products as $product): ?>
                <div class="col-md-4 mb-4">
                    <a href="/products/<?= $product['product_id']; ?>" class="list-group-item list-group-item-action">
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-muted">Sold by: <a href="/shops/<?= $product['store_id'] ?>">Store Name</a></p>
                            </div>
