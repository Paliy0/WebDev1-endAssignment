    ...
    <div class="row mb-4">
        <div class="col-md-4">
            <?php if (!empty($shop['img'])): ?>
                <img src="<?= htmlspecialchars($shop['img']) ?>" class="img-fluid rounded" alt="<?= htmlspecialchars($shop['name']) ?>">
            <?php else: ?>
                ...
                <div class="col-md-3 mb-4">
                    <div class="card h-100">
                        <?php if (!empty($product['img'])): ?>
                            <img src="<?= htmlspecialchars($product['img']) ?>" class="card-img-top" alt="<?= htmlspecialchars($product['name']) ?>" style="height: 180px; object-fit: cover;">
                        <?php else: ?>
