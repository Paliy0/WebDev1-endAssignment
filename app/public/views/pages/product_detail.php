    ...
    <div class="row">
        <div class="col-md-6">
            <?php if (!empty($product['img'])): ?>
                <img src="<?= htmlspecialchars($product['img']) ?>" class="img-fluid rounded" alt="<?= htmlspecialchars($product['name']) ?>">
            <?php else: ?>
        ...
        <div class="col-md-6">
            ...
            <div class="mt-4">
                ...
                <a href="/shops/<?= $product['shop_id'] ?>/products" class="btn btn-outline-secondary">More from this Shop</a>
            </div>
        </div>
    </div>
</main>
